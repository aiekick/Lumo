...
{
public:
	static std::shared_ptr<HistorizeNode> Create(GaiApi::VulkanCorePtr vVulkanCorePtr);

private:
	std::shared_ptr<HistorizeModule> m_HistorizeModulePtr = nullptr;

public:
	HistorizeNode();
	~HistorizeNode() override;
