...
{
public:
	static std::shared_ptr<HistorizeModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<HistorizeModule> m_This;

	std::shared_ptr<HistorizeModule_Comp_2D_Pass> m_HistorizeModule_Comp_2D_Pass_Ptr = nullptr;

public:
	HistorizeModule(vkApi::VulkanCorePtr vVulkanCorePtr);
