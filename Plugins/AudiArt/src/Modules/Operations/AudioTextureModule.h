...
{
public:
	static std::shared_ptr<AudioTextureModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<AudioTextureModule> m_This;

	std::shared_ptr<AudioTextureModule_Comp_2D_Pass> m_AudioTextureModule_Comp_2D_Pass_Ptr = nullptr;

public:
	AudioTextureModule(vkApi::VulkanCorePtr vVulkanCorePtr);
