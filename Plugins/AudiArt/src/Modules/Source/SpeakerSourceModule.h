...
{
public:
	static std::shared_ptr<SpeakerSourceModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<SpeakerSourceModule> m_This;
	vkApi::VulkanCorePtr m_VulkanCorePtr = nullptr;

public:
	SpeakerSourceModule(vkApi::VulkanCorePtr vVulkanCorePtr);
	~SpeakerSourceModule();
