...
{
public:
	static std::shared_ptr<BlackmanFilterModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<BlackmanFilterModule> m_This;
	vkApi::VulkanCorePtr m_VulkanCorePtr = nullptr;

public:
	BlackmanFilterModule(vkApi::VulkanCorePtr vVulkanCorePtr);
