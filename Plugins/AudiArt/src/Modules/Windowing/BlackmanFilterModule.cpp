...
std::shared_ptr<BlackmanFilterModule> BlackmanFilterModule::Create(GaiApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode)
{
	ZoneScoped;
...
BlackmanFilterModule::BlackmanFilterModule(GaiApi::VulkanCorePtr vVulkanCorePtr)
...
bool BlackmanFilterModule::DrawWidgets(const uint32_t& vCurrentFrame, ImGuiContext* vContextPtr, const std::string& vUserDatas)
{
	ZoneScoped;
