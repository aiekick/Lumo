...
{
public:
	static std::shared_ptr<VisuHexGridModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<VisuHexGridModule> m_This;

	std::shared_ptr<VisuHexGridModule_Vertex_Pass> m_VisuHexGridModule_Vertex_Pass_Ptr = nullptr;

public:
	VisuHexGridModule(vkApi::VulkanCorePtr vVulkanCorePtr);
