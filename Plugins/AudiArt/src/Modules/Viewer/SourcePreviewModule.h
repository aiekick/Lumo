...
{
public:
	static std::shared_ptr<SourcePreviewModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<SourcePreviewModule> m_This;
	vkApi::VulkanCorePtr m_VulkanCorePtr = nullptr;

public:
	SourcePreviewModule(vkApi::VulkanCorePtr vVulkanCorePtr);
	~SourcePreviewModule();
