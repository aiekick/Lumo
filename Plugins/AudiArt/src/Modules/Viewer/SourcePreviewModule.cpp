...
std::shared_ptr<SourcePreviewModule> SourcePreviewModule::Create(GaiApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode)
{
	ZoneScoped;
...
SourcePreviewModule::SourcePreviewModule(GaiApi::VulkanCorePtr vVulkanCorePtr)
