...
{
public:
	static std::shared_ptr<SoundFFTModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<SoundFFTModule> m_This;
	vkApi::VulkanCorePtr m_VulkanCorePtr = nullptr;

public:
	SoundFFTModule(vkApi::VulkanCorePtr vVulkanCorePtr);
	~SoundFFTModule();
