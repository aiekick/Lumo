...
class SdfTextureModule;
class SdfTextureNode : public BaseNode, public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface {
public:
    static std::shared_ptr<SdfTextureNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);

private:
    std::shared_ptr<SdfTextureModule> m_SdfTextureModulePtr = nullptr;

public:
    SdfTextureNode();
    ~SdfTextureNode() override;
