...
{
public:
	static std::shared_ptr<FogModule> Create(GaiApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	std::weak_ptr<FogModule> m_This;

	std::shared_ptr<FogModule_Comp_2D_Pass> m_FogModule_Comp_2D_Pass_Ptr = nullptr;

public:
	FogModule(GaiApi::VulkanCorePtr vVulkanCorePtr);
	~FogModule() override;
