...
{
public:
	static std::shared_ptr<HeatMapModule> Create(GaiApi::VulkanCoreWeak vVulkanCore, BaseNodeWeak vParentNode);

private:
	std::weak_ptr<HeatMapModule> m_This;

	std::shared_ptr<HeatMapModule_Comp_2D_Pass> m_HeatMapModule_Comp_2D_Pass_Ptr = nullptr;

public:
	HeatMapModule(GaiApi::VulkanCoreWeak vVulkanCore);
	~HeatMapModule() override;
