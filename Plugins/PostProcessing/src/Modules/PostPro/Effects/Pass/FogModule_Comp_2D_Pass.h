...
{
public:
	static std::shared_ptr<FogModule_Comp_2D_Pass> Create(const ct::uvec2& vSize, GaiApi::VulkanCorePtr vVulkanCorePtr);
...
public:
	FogModule_Comp_2D_Pass(GaiApi::VulkanCorePtr vVulkanCorePtr);
	~FogModule_Comp_2D_Pass() override;
