...
{
public:
	static std::shared_ptr<ColorBalanceModule_Comp_2D_Pass> Create(const ct::uvec2& vSize, GaiApi::VulkanCorePtr vVulkanCorePtr);

private:
	struct UBO_Comp {
		alignas(4) float u_red = 0.0f;
		alignas(4) float u_green = 0.0f;
		alignas(4) float u_blue = 0.0f;
...
public:
	ColorBalanceModule_Comp_2D_Pass(GaiApi::VulkanCorePtr vVulkanCorePtr);
	~ColorBalanceModule_Comp_2D_Pass() override;
