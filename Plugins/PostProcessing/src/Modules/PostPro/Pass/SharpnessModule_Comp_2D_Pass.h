...
{
public:
	static std::shared_ptr<SharpnessModule_Comp_2D_Pass> Create(const ct::uvec2& vSize, GaiApi::VulkanCorePtr vVulkanCorePtr);
...
public:
	SharpnessModule_Comp_2D_Pass(GaiApi::VulkanCorePtr vVulkanCorePtr);
