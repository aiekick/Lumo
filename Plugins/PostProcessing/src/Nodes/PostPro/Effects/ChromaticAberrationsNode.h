...
class ChromaticAberrationsModule;
class ChromaticAberrationsNode : public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface, public BaseNode {
public:
    static std::shared_ptr<ChromaticAberrationsNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);

private:
    std::shared_ptr<ChromaticAberrationsModule> m_ChromaticAberrationsModulePtr = nullptr;

public:
    ChromaticAberrationsNode();
    ~ChromaticAberrationsNode() override;
