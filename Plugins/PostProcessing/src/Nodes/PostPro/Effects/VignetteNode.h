...
class VignetteNode : public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface, public BaseNode {
public:
    static std::shared_ptr<VignetteNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);

private:
    std::shared_ptr<VignetteModule> m_VignetteModulePtr = nullptr;
