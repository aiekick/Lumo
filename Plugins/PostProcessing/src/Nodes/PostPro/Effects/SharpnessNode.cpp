...
std::shared_ptr<SharpnessNode> SharpnessNode::Create(GaiApi::VulkanCorePtr vVulkanCorePtr)
{
	ZoneScoped;
...
bool SharpnessNode::Init(GaiApi::VulkanCorePtr vVulkanCorePtr)
{
	ZoneScoped;
	...
	m_SharpnessModulePtr = SharpnessModule::Create(vVulkanCorePtr, m_This);
...
bool SharpnessNode::DrawWidgets(const uint32_t& vCurrentFrame, ImGuiContext* vContextPtr, const std::string& vUserDatas)
{
	ZoneScoped;
	bool res = false;
	assert(vContextPtr); 
...
bool SharpnessNode::DrawOverlays(const uint32_t& vCurrentFrame, const ImRect& vRect, ImGuiContext* vContextPtr, const std::string& vUserDatas)
{
	ZoneScoped;
...
bool SharpnessNode::DrawDialogsAndPopups(const uint32_t& vCurrentFrame, const ImVec2& vMaxSize, ImGuiContext* vContextPtr, const std::string& vUserDatas)
{
	ZoneScoped;
	assert(vContextPtr); 
	ImGui::SetCurrentContext(vContextPtr);
