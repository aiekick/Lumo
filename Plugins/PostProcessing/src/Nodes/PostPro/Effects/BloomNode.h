...
class BloomModule;
class BloomNode : public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface, public BaseNode {
public:
    static std::shared_ptr<BloomNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);

private:
    std::shared_ptr<BloomModule> m_BloomModulePtr = nullptr;
