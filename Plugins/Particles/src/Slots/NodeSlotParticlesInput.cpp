...
NodeSlotParticlesInput::NodeSlotParticlesInput()
	: NodeSlotInput("", "PARTICLES")
{
	pinID = sGetNewSlotId();
...
NodeSlotParticlesInput::NodeSlotParticlesInput(const std::string& vName)
	: NodeSlotInput(vName, "PARTICLES")
{
	pinID = sGetNewSlotId();
	color = sGetSlotColors()->GetSlotColor(slotType);
	colorIsSet = true;
...
NodeSlotParticlesInput::NodeSlotParticlesInput(const std::string& vName, const bool& vHideName)
	: NodeSlotInput(vName, "PARTICLES", vHideName)
{
	pinID = sGetNewSlotId();
	color = sGetSlotColors()->GetSlotColor(slotType);
	colorIsSet = true;
...
void NodeSlotParticlesInput::TreatNotification(
	NotifyEvent vEvent,
