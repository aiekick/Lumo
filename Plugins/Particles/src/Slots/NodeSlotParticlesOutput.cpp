...
NodeSlotParticlesOutput::NodeSlotParticlesOutput()
	: NodeSlotOutput("", "PARTICLES")
{
	pinID = sGetNewSlotId();
...
NodeSlotParticlesOutput::NodeSlotParticlesOutput(const std::string& vName)
	: NodeSlotOutput(vName, "PARTICLES")
{
	pinID = sGetNewSlotId();
	color = sGetSlotColors()->GetSlotColor(slotType);
	colorIsSet = true;
...
NodeSlotParticlesOutput::NodeSlotParticlesOutput(const std::string& vName, const bool& vHideName)
	: NodeSlotOutput(vName, "PARTICLES", vHideName)
{
	pinID = sGetNewSlotId();
	color = sGetSlotColors()->GetSlotColor(slotType);
	colorIsSet = true;
