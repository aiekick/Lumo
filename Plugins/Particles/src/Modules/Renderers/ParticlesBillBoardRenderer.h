...
class ParticlesBillBoardRenderer :
	public BaseRenderer,
...
{
public:
	static std::shared_ptr<ParticlesBillBoardRenderer> Create(vkApi::VulkanCorePtr vVulkanCorePtr);

private:
	std::shared_ptr<ParticlesBillBoardRenderer_Mesh_Pass> m_ParticlesBillBoardRenderer_Mesh_Pass_Ptr = nullptr;

public:
	ParticlesBillBoardRenderer(vkApi::VulkanCorePtr vVulkanCorePtr);
	~ParticlesBillBoardRenderer() override;
