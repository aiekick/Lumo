...
#include "PrimitiveFibonacciModule_Comp_Pass.h"
...
PrimitiveFibonacciModule_Comp_Pass::PrimitiveFibonacciModule_Comp_Pass(vkApi::VulkanCorePtr vVulkanCorePtr)
...
bool PrimitiveFibonacciModule_Comp_Pass::DrawWidgets(const uint32_t& vCurrentFrame, ImGuiContext* vContext)
{
	assert(vContext);
...
void PrimitiveFibonacciModule_Comp_Pass::DrawOverlays(const uint32_t& vCurrentFrame, const ct::frect& vRect, ImGuiContext* vContext)
{
	assert(vContext);
}

void PrimitiveFibonacciModule_Comp_Pass::DisplayDialogsAndPopups(const uint32_t& vCurrentFrame, const ct::ivec2& vMaxSize, ImGuiContext* vContext)
{
	assert(vContext);
}

vk::Buffer* PrimitiveFibonacciModule_Comp_Pass::GetTexelBuffer(const uint32_t& vBindingPoint, ct::uvec2* vOutSize)
{
	ZoneScoped;
...
vk::BufferView* PrimitiveFibonacciModule_Comp_Pass::GetTexelBufferView(const uint32_t& vBindingPoint, ct::uvec2* vOutSize)
{
	ZoneScoped;
...
void PrimitiveFibonacciModule_Comp_Pass::Compute(vk::CommandBuffer* vCmdBuffer, const int& vIterationNumber)
{
	if (vCmdBuffer)
	{
...
bool PrimitiveFibonacciModule_Comp_Pass::BuildModel()
{
	ZoneScoped;
...
void PrimitiveFibonacciModule_Comp_Pass::DestroyModel(const bool& vReleaseDatas)
{
	m_Particle_pos3_life1_dir3_speed4_color4_buffer_Ptr.reset();
}

bool PrimitiveFibonacciModule_Comp_Pass::CreateUBO()
{
	ZoneScoped;
...
void PrimitiveFibonacciModule_Comp_Pass::UploadUBO()
{
	ZoneScoped;
...
void PrimitiveFibonacciModule_Comp_Pass::DestroyUBO()
{
	ZoneScoped;
...
bool PrimitiveFibonacciModule_Comp_Pass::UpdateLayoutBindingInRessourceDescriptor()
{
	ZoneScoped;
...
bool PrimitiveFibonacciModule_Comp_Pass::UpdateBufferInfoInRessourceDescriptor()
{
	ZoneScoped;
...
std::string PrimitiveFibonacciModule_Comp_Pass::GetComputeShaderCode(std::string& vOutShaderName)
{
	vOutShaderName = "PrimitiveFibonacciModule_Comp_Pass";
...
std::string PrimitiveFibonacciModule_Comp_Pass::getXml(const std::string& vOffset, const std::string& /*vUserDatas*/)
{
	std::string str;
...
bool PrimitiveFibonacciModule_Comp_Pass::setFromXml(tinyxml2::XMLElement* vElem, tinyxml2::XMLElement* vParent, const std::string& /*vUserDatas*/)
{
