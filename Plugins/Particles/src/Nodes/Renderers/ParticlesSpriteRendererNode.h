...
{
public:
	static std::shared_ptr<ParticlesSpriteRendererNode> Create(vkApi::VulkanCorePtr vVulkanCorePtr);

private:
	std::shared_ptr<ParticlesSpriteRenderer> m_ParticlesSpriteRenderer = nullptr;

public:
	ParticlesSpriteRendererNode();
	~ParticlesSpriteRendererNode() override;
