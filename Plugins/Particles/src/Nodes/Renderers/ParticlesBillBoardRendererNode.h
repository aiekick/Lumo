...
class ParticlesBillBoardRendererNode : 
	public BaseNode, 
...
{
public:
	static std::shared_ptr<ParticlesBillBoardRendererNode> Create(vkApi::VulkanCorePtr vVulkanCorePtr);

private:
	std::shared_ptr<ParticlesBillBoardRenderer> m_ParticlesBillBoardRenderer = nullptr;

public:
	ParticlesBillBoardRendererNode();
	~ParticlesBillBoardRendererNode() override;
