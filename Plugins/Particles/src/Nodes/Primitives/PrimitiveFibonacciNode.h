...
{
public:
	static std::shared_ptr<PrimitiveFibonacciNode> Create(vkApi::VulkanCorePtr vVulkanCorePtr);

private:
	std::shared_ptr<PrimitiveFibonacciModule> m_PrimitiveFibonacciModulePtr = nullptr;

public:
	PrimitiveFibonacciNode();
	~PrimitiveFibonacciNode() override;
