...
public:
	static std::shared_ptr<ParametricCurveDiffModule> Create(GaiApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);
...
public:
	ParametricCurveDiffModule(GaiApi::VulkanCorePtr vVulkanCorePtr);
