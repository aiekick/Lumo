...
public:
	static std::shared_ptr<ParametricCurveModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<ParametricCurveModule> m_This;
...
public:
	ParametricCurveModule(vkApi::VulkanCorePtr vVulkanCorePtr);
