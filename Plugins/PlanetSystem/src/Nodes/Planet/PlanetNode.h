...
class PlanetModule;
class PlanetNode : public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface, public BaseNode {
public:
    static std::shared_ptr<PlanetNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);
