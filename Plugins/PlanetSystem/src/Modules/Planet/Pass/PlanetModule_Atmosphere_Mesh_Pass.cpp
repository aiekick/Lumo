...
PlanetModule_Atmosphere_Mesh_Pass::PlanetModule_Atmosphere_Mesh_Pass(GaiApi::VulkanCorePtr vVulkanCorePtr)
...
bool PlanetModule_Atmosphere_Mesh_Pass::DrawWidgets(const uint32_t& vCurrentFrame, ImGuiContext* vContext)
{
	ZoneScoped;
...
void PlanetModule_Atmosphere_Mesh_Pass::DrawOverlays(const uint32_t& vCurrentFrame, const ct::frect& vRect, ImGuiContext* vContext)
{
	ZoneScoped;
...
void PlanetModule_Atmosphere_Mesh_Pass::DisplayDialogsAndPopups(const uint32_t& vCurrentFrame, const ct::ivec2& vMaxSize, ImGuiContext* vContext)
{
	ZoneScoped;
