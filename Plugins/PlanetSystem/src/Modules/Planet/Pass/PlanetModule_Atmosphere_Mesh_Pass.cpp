...
PlanetModule_Atmosphere_Mesh_Pass::PlanetModule_Atmosphere_Mesh_Pass(GaiApi::VulkanCoreWeak vVulkanCore)
...
bool PlanetModule_Atmosphere_Mesh_Pass::DrawWidgets(const uint32_t& vCurrentFrame, ImGuiContext* vContextPtr, const std::string& vUserDatas) {
    ...
    if (ImGui::CollapsingHeader("Atmosphere : Mesh Analyze")) {
        ...
        if (!m_Vertices.m_Array.empty() && !m_Indices.m_Array.empty()) {
            ...
            if (m_UseIndiceRestriction) {
                need_ubos_update |= ImGui::SliderUIntDefaultCompact(0.0f, "count indices##atmosphere", &m_RestrictedIndicesCountToDraw, 0,
    ...
    if (ImGui::CollapsingHeader("Atmosphere : Mesh Tesselation")) {
        ...
        need_ubos_update |=
            ImGui::SliderFloatDefaultCompact(0.0f, "Tesselation level##atmosphere", &m_UBO_Tess_Ctrl.u_tesselation_level, 0.0f, 100.0f, 1.0f);
        need_ubos_update |=
            ImGui::SliderFloatDefaultCompact(0.0f, "Displacement Factor##atmosphere", &m_UBO_Tess_Eval.u_displace_factor, 0.0f, 2.0f, 1.0f);
...
bool PlanetModule_Atmosphere_Mesh_Pass::DrawOverlays(
...
bool PlanetModule_Atmosphere_Mesh_Pass::DrawDialogsAndPopups(
...
void PlanetModule_Atmosphere_Mesh_Pass::SetTexture(const uint32_t& vBindingPoint, vk::DescriptorImageInfo* vImageInfo, ct::fvec2* vTextureSize, void* vUserDatas) {
    ZoneScoped;
...
vk::DescriptorImageInfo* PlanetModule_Atmosphere_Mesh_Pass::GetDescriptorImageInfo(const uint32_t& vBindingPoint, ct::fvec2* vOutSize, void* vUserDatas) {
    ZoneScoped;
...
void PlanetModule_Atmosphere_Mesh_Pass::WasJustResized() {
    ZoneScoped;
}
...
size_t PlanetModule_Atmosphere_Mesh_Pass::GetMiddlePoint_Plane(
...
void PlanetModule_Atmosphere_Mesh_Pass::Subdivide(
