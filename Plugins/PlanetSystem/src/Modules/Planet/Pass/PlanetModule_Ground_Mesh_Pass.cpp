...
PlanetModule_Ground_Mesh_Pass::PlanetModule_Ground_Mesh_Pass(GaiApi::VulkanCoreWeak vVulkanCore)
...
bool PlanetModule_Ground_Mesh_Pass::DrawWidgets(const uint32_t& vCurrentFrame, ImGuiContext* vContextPtr, const std::string& vUserDatas) {
    ZoneScoped;
...
bool PlanetModule_Ground_Mesh_Pass::DrawOverlays(
...
bool PlanetModule_Ground_Mesh_Pass::DrawDialogsAndPopups(
...
void PlanetModule_Ground_Mesh_Pass::SetTexture(const uint32_t& vBindingPoint, vk::DescriptorImageInfo* vImageInfo, ct::fvec2* vTextureSize, void* vUserDatas) {
    ZoneScoped;
...
vk::DescriptorImageInfo* PlanetModule_Ground_Mesh_Pass::GetDescriptorImageInfo(const uint32_t& vBindingPoint, ct::fvec2* vOutSize, void* vUserDatas) {
    ZoneScoped;
...
size_t PlanetModule_Ground_Mesh_Pass::GetMiddlePoint_Plane(
...
void PlanetModule_Ground_Mesh_Pass::Subdivide(
