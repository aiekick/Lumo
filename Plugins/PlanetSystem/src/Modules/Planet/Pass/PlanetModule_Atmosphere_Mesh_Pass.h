...
class PlanetModule_Atmosphere_Mesh_Pass : public MeshShaderPass<VertexStruct::P3_N3_C4>,
...
public:
    PlanetModule_Atmosphere_Mesh_Pass(GaiApi::VulkanCoreWeak vVulkanCore);
