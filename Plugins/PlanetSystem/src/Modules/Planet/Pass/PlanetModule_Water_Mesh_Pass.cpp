...
PlanetModule_Water_Mesh_Pass::PlanetModule_Water_Mesh_Pass(GaiApi::VulkanCorePtr vVulkanCorePtr) : MeshShaderPass<VertexStruct::P3_N3_C4>(vVulkanCorePtr, MeshShaderPassType::PIXEL) {
    ZoneScoped;
