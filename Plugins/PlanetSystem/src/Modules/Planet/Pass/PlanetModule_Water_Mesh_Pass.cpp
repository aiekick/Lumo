...
bool PlanetModule_Water_Mesh_Pass::DrawWidgets(const uint32_t& vCurrentFrame, ImGuiContext* vContextPtr, const std::string& vUserDatas) {
    ZoneScoped;
...
void PlanetModule_Water_Mesh_Pass::SetTexture(const uint32_t& vBindingPoint, vk::DescriptorImageInfo* vImageInfo, ct::fvec2* vTextureSize, void* vUserDatas) {
    ZoneScoped;
...
vk::DescriptorImageInfo* PlanetModule_Water_Mesh_Pass::GetDescriptorImageInfo(const uint32_t& vBindingPoint, ct::fvec2* vOutSize, void* vUserDatas) {
    ZoneScoped;
...
bool PlanetModule_Water_Mesh_Pass::CreateUBO() {
    ...
    m_UBO_Vert_Ptr = VulkanRessource::createUniformBufferObject(m_VulkanCore, sizeof(UBO_Vert), "PlanetModule_Water_Mesh_Pass");
    ...
    m_UBO_Tess_Ctrl_Ptr = VulkanRessource::createUniformBufferObject(m_VulkanCore, sizeof(UBO_Tess_Ctrl), "PlanetModule_Water_Mesh_Pass");
    ...
    m_UBO_Tess_Eval_Ptr = VulkanRessource::createUniformBufferObject(m_VulkanCore, sizeof(UBO_Tess_Eval), "PlanetModule_Water_Mesh_Pass");
    ...
    m_UBO_Frag_Ptr = VulkanRessource::createUniformBufferObject(m_VulkanCore, sizeof(UBO_Frag), "PlanetModule_Water_Mesh_Pass");
