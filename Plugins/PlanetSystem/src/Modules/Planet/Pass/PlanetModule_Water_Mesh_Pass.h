...
class PlanetModule_Water_Mesh_Pass : public MeshShaderPass<VertexStruct::P3_N3_C4>,
...
public:
    PlanetModule_Water_Mesh_Pass(GaiApi::VulkanCoreWeak vVulkanCore);
    ~PlanetModule_Water_Mesh_Pass() override;
