...
ToneMapModule_Quad_Pass::~ToneMapModule_Quad_Pass()
{
	Unit();
}

void ToneMapModule_Quad_Pass::ActionBeforeInit()
{
...
void ToneMapModule_Quad_Pass::SetTexture(const uint32_t& vBinding, vk::DescriptorImageInfo* vImageInfo, ct::fvec2* vTextureSize)
{
	ZoneScoped;
...
vk::DescriptorImageInfo* ToneMapModule_Quad_Pass::GetDescriptorImageInfo(const uint32_t& vBindingPoint, ct::fvec2* vOutSize)
{
	if (m_FrameBufferPtr)
	{
		if (vOutSize)
...
bool ToneMapModule_Quad_Pass::CreateUBO()
{
	ZoneScoped;
...
void ToneMapModule_Quad_Pass::UploadUBO()
{
	ZoneScoped;
...
void ToneMapModule_Quad_Pass::DestroyUBO()
{
	ZoneScoped;
...
bool ToneMapModule_Quad_Pass::UpdateLayoutBindingInRessourceDescriptor()
{
	ZoneScoped;
...
bool ToneMapModule_Quad_Pass::UpdateBufferInfoInRessourceDescriptor()
{
	ZoneScoped;
	...
	m_DescriptorSets[0].m_WriteDescriptorSets.emplace_back(m_DescriptorSets[0].m_DescriptorSet, 2U, 0, 1, vk::DescriptorType::eCombinedImageSampler, &m_ImageInfos[0], nullptr); // ssao

	return true;
}

std::string ToneMapModule_Quad_Pass::GetVertexShaderCode(std::string& vOutShaderName)
{
...
std::string ToneMapModule_Quad_Pass::GetFragmentShaderCode(std::string& vOutShaderName)
{
	vOutShaderName = "ToneMapModule_Quad_Pass";
...
std::string ToneMapModule_Quad_Pass::GetStructToXMLString(const char* vBalise, float* vStartItem, size_t vCountItem)
{
...
std::string ToneMapModule_Quad_Pass::getXml(const std::string& vOffset, const std::string& /*vUserDatas*/)
{
	std::string str;
...
void ToneMapModule_Quad_Pass::LoadStructFromToXMLString(const std::string& vXMLString, float* vStartItem, size_t vCountItem)
{
	if (!vXMLString.empty())
	{
...
bool ToneMapModule_Quad_Pass::setFromXml(tinyxml2::XMLElement* vElem, tinyxml2::XMLElement* vParent, const std::string& /*vUserDatas*/)
{
