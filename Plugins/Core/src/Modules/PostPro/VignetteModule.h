...
{
public:
	static std::shared_ptr<VignetteModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<VignetteModule> m_This;

	std::shared_ptr<VignetteModule_Comp_2D_Pass> m_VignetteModule_Comp_2D_Pass_Ptr = nullptr;

public:
	VignetteModule(vkApi::VulkanCorePtr vVulkanCorePtr);
