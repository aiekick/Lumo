...
#include "GrayScottModule_Quad_Pass.h"
...
GrayScottModule_Quad_Pass::GrayScottModule_Quad_Pass(vkApi::VulkanCorePtr vVulkanCorePtr)
...
GrayScottModule_Quad_Pass::~GrayScottModule_Quad_Pass()
{
	Unit();
}
...
void GrayScottModule_Quad_Pass::SetTexture(const uint32_t& vBinding, vk::DescriptorImageInfo* vImageInfo, ct::fvec2* vTextureSize)
{
	ZoneScoped;
...
vk::DescriptorImageInfo* GrayScottModule_Quad_Pass::GetDescriptorImageInfo(const uint32_t& vBindingPoint, ct::fvec2* vOutSize)
{
	if (m_FrameBufferPtr)
	{
		if (vOutSize)
...
bool GrayScottModule_Quad_Pass::CreateUBO()
{
	ZoneScoped;
...
void GrayScottModule_Quad_Pass::UploadUBO()
{
	ZoneScoped;
...
void GrayScottModule_Quad_Pass::DestroyUBO()
{
	ZoneScoped;
...
bool GrayScottModule_Quad_Pass::UpdateLayoutBindingInRessourceDescriptor()
{
	ZoneScoped;
...
bool GrayScottModule_Quad_Pass::UpdateBufferInfoInRessourceDescriptor()
{
	ZoneScoped;
...
std::string GrayScottModule_Quad_Pass::GetVertexShaderCode(std::string& vOutShaderName)
{
...
std::string GrayScottModule_Quad_Pass::GetFragmentShaderCode(std::string& vOutShaderName)
{
	vOutShaderName = "GrayScottModule_Quad_Pass";
...
std::string GrayScottModule_Quad_Pass::getXml(const std::string& vOffset, const std::string& /*vUserDatas*/)
{
	std::string str;
...
bool GrayScottModule_Quad_Pass::setFromXml(tinyxml2::XMLElement* vElem, tinyxml2::XMLElement* vParent, const std::string& /*vUserDatas*/)
{
