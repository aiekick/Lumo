...
{
public:
	static std::shared_ptr<AlienRockModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<AlienRockModule> m_This;

	std::shared_ptr<AlienRockModule_Mesh_Pass> m_AlienRockModule_Mesh_Pass_Ptr = nullptr;

public:
	AlienRockModule(vkApi::VulkanCorePtr vVulkanCorePtr);
