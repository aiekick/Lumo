...
class DivergenceModule_Comp_2D_Pass;
...
{
public:
	static std::shared_ptr<DivergenceModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<DivergenceModule> m_This;

	std::shared_ptr<DivergenceModule_Comp_2D_Pass> m_DivergenceModule_Comp_2D_Pass_Ptr = nullptr;

public:
	DivergenceModule(vkApi::VulkanCorePtr vVulkanCorePtr);
