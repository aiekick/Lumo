...
{
public:
	static std::shared_ptr<FlatGradientModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<FlatGradientModule> m_This;
	std::shared_ptr<FlatGradientModule_Comp_2D_Pass> m_FlatGradientModule_Comp_2D_Pass_Ptr = nullptr;
	uint32_t m_Output_Width = 0U;

public:
	FlatGradientModule(vkApi::VulkanCorePtr vVulkanCorePtr);
