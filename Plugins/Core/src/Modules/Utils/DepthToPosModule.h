...
class DepthToPosModule_Quad_Pass;
...
{
public:
	static std::shared_ptr<DepthToPosModule> Create(GaiApi::VulkanCorePtr vVulkanCorePtr);

private:
	std::shared_ptr<DepthToPosModule_Quad_Pass> m_DepthToPosModule_Quad_Pass_Ptr = nullptr;

public:
	DepthToPosModule(GaiApi::VulkanCorePtr vVulkanCorePtr);
