...
bool BillBoardRendererModule::Init()
{
	...
	if (BaseRenderer::InitPixel(map_size))
	{
		...
		if (m_BillBoardRendererModule_Mesh_Pass_Ptr)
		{
			...
			//m_BillBoardRendererModule_Mesh_Pass_Ptr->AllowResizeOnResizeEvents(false);
			//m_BillBoardRendererModule_Mesh_Pass_Ptr->AllowResizeByHand(true);

			if (m_BillBoardRendererModule_Mesh_Pass_Ptr->InitPixel(map_size, 1U, true, true, 0.0f,
