...
bool HeatmapRenderer_Mesh_Pass::UpdateLayoutBindingInRessourceDescriptor()
{
	...
	m_DescriptorSets[0].m_LayoutBindings.emplace_back(3U, vk::DescriptorType::eStorageBuffer, 1, vk::ShaderStageFlagBits::eFragment);
...
bool HeatmapRenderer_Mesh_Pass::UpdateBufferInfoInRessourceDescriptor()
{
	...
	m_DescriptorSets[0].m_WriteDescriptorSets.emplace_back(m_DescriptorSets[0].m_DescriptorSet, 3U, 0, 1, vk::DescriptorType::eStorageBuffer, nullptr, &m_SBO_ColorsDescriptorBufferInfo);
