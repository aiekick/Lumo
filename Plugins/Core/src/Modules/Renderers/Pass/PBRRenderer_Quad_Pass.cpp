...
bool PBRRenderer_Quad_Pass::UpdateLayoutBindingInRessourceDescriptor()
{
	...
	m_DescriptorSets[0].m_LayoutBindings.emplace_back(7U, vk::DescriptorType::eStorageBuffer, 1, vk::ShaderStageFlagBits::eFragment);

	// the shadow maps
	m_DescriptorSets[0].m_LayoutBindings.emplace_back(8U, vk::DescriptorType::eCombinedImageSampler,
...
bool PBRRenderer_Quad_Pass::UpdateBufferInfoInRessourceDescriptor()
{
	...
	m_DescriptorSets[0].m_WriteDescriptorSets.emplace_back(m_DescriptorSets[0].m_DescriptorSet, 5U, 0, 1, vk::DescriptorType::eCombinedImageSampler, &m_ImageInfos[3], nullptr); // mask
	m_DescriptorSets[0].m_WriteDescriptorSets.emplace_back(m_DescriptorSets[0].m_DescriptorSet, 6U, 0, 1, vk::DescriptorType::eCombinedImageSampler, &m_ImageInfos[4], nullptr); // ssaao
	m_DescriptorSets[0].m_WriteDescriptorSets.emplace_back(m_DescriptorSets[0].m_DescriptorSet, 7U, 0, 1, vk::DescriptorType::eStorageBuffer, nullptr, m_SceneLightGroupDescriptorInfoPtr);

	// the shadow maps
	m_DescriptorSets[0].m_WriteDescriptorSets.emplace_back(m_DescriptorSets[0].m_DescriptorSet, 8U, 0,
