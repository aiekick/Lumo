...
{
public:
	static std::shared_ptr<ReflectionModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<ReflectionModule> m_This;

	std::shared_ptr<Reflection_Quad_Pass> m_Reflection_Quad_Pass_Ptr = nullptr;

public:
	ReflectionModule(vkApi::VulkanCorePtr vVulkanCorePtr);
