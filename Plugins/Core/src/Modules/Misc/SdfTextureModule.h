...
{
public:
	static std::shared_ptr<SdfTextureModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr);

private:
	ct::cWeak<SdfTextureModule> m_This;

	std::shared_ptr<SdfTextureModule_Comp_Pass> m_SdfTextureModule_Comp_Pass_Ptr = nullptr;

public:
	SdfTextureModule(vkApi::VulkanCorePtr vVulkanCorePtr);
