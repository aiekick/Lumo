...
#include "PbrRenderer_Rtx_Pass.h"
...
PbrRenderer_Rtx_Pass::PbrRenderer_Rtx_Pass(vkApi::VulkanCorePtr vVulkanCorePtr)
...
PbrRenderer_Rtx_Pass::~PbrRenderer_Rtx_Pass()
{
	ZoneScoped;
...
void PbrRenderer_Rtx_Pass::DrawOverlays(const uint32_t& vCurrentFrame, const ct::frect& vRect, ImGuiContext* vContext)
{
	ZoneScoped;
...
void PbrRenderer_Rtx_Pass::DisplayDialogsAndPopups(const uint32_t& vCurrentFrame, const ct::ivec2& vMaxSize, ImGuiContext* vContext)
{
	ZoneScoped;
...
vk::DescriptorImageInfo* PbrRenderer_Rtx_Pass::GetDescriptorImageInfo(const uint32_t& vBindingPoint, ct::fvec2* vOutSize)
{
	ZoneScoped;
...
void PbrRenderer_Rtx_Pass::SetLightGroup(SceneLightGroupWeak vSceneLightGroup)
{
	ZoneScoped;
...
std::string PbrRenderer_Rtx_Pass::getXml(const std::string& vOffset, const std::string& vUserDatas)
{
	ZoneScoped;
...
bool PbrRenderer_Rtx_Pass::setFromXml(tinyxml2::XMLElement* vElem, tinyxml2::XMLElement* vParent, const std::string& vUserDatas)
{
	ZoneScoped;
...
bool PbrRenderer_Rtx_Pass::CanRender()
{
	ZoneScoped;
...
bool PbrRenderer_Rtx_Pass::CanUpdateDescriptors()
{
	ZoneScoped;
...
bool PbrRenderer_Rtx_Pass::UpdateLayoutBindingInRessourceDescriptor()
{
	ZoneScoped;
...
bool PbrRenderer_Rtx_Pass::UpdateBufferInfoInRessourceDescriptor()
{
	ZoneScoped;
