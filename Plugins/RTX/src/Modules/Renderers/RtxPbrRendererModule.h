...
{
public:
	static std::shared_ptr<RtxPbrRendererModule> Create(vkApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	ct::cWeak<RtxPbrRendererModule> m_This;

	std::shared_ptr<RtxPbrRendererModule_Rtx_Pass> m_RtxPbrRendererModule_Rtx_Pass_Ptr = nullptr;

public:
	RtxPbrRendererModule(vkApi::VulkanCorePtr vVulkanCorePtr);
