...
NodeSlotAccelStructureOutput::NodeSlotAccelStructureOutput() : NodeSlotOutput("", "RTX_ACCEL_STRUCTURE") {
    pinID = sGetNewSlotId();
    color = sGetSlotColors()->GetSlotColor(slotType);
    colorIsSet = true;
}

NodeSlotAccelStructureOutput::NodeSlotAccelStructureOutput(const std::string& vName) : NodeSlotOutput(vName, "RTX_ACCEL_STRUCTURE") {
    pinID = sGetNewSlotId();
    color = sGetSlotColors()->GetSlotColor(slotType);
    colorIsSet = true;
}
