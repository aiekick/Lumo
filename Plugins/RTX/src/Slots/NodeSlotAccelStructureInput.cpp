...
NodeSlotAccelStructureInput::NodeSlotAccelStructureInput() : NodeSlotInput("", "RTX_ACCEL_STRUCTURE") {
    pinID = sGetNewSlotId();
    color = sGetSlotColors()->GetSlotColor(slotType);
    colorIsSet = true;
}

NodeSlotAccelStructureInput::NodeSlotAccelStructureInput(const std::string& vName) : NodeSlotInput(vName, "RTX_ACCEL_STRUCTURE") {
    pinID = sGetNewSlotId();
    color = sGetSlotColors()->GetSlotColor(slotType);
    colorIsSet = true;
}
...
void NodeSlotAccelStructureInput::TreatNotification(NotifyEvent vEvent, const NodeSlotWeak& vEmitterSlot, const NodeSlotWeak& /*vReceiverSlot*/) {
