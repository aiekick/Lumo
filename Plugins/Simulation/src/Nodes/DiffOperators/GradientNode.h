...
class GradientNode : public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface, public BaseNode {
public:
    static std::shared_ptr<GradientNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);
