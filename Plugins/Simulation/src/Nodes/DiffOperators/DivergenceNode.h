...
class DivergenceNode : public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface, public BaseNode {
public:
    static std::shared_ptr<DivergenceNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);

private:
    std::shared_ptr<DivergenceModule> m_DivergenceModulePtr = nullptr;

public:
    DivergenceNode();
    ~DivergenceNode() override;
