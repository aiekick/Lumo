...
class ConwayModule;
class ConwayNode : public BaseNode, public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface {
public:
    static std::shared_ptr<ConwayNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);

private:
    std::shared_ptr<ConwayModule> m_ConwayModulePtr = nullptr;
