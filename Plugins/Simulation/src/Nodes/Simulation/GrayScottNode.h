...
class GrayScottNode : public BaseNode, public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface {
public:
    static std::shared_ptr<GrayScottNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);
