...
{
public:
	static std::shared_ptr<VolumeRenderingNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);

private:
	std::shared_ptr<VolumeRenderingModule> m_VolumeRenderingModulePtr = nullptr;

public:
	VolumeRenderingNode();
	~VolumeRenderingNode() override;
