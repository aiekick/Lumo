...
{
public:
	static std::shared_ptr<VolumeRenderingModule> Create(GaiApi::VulkanCoreWeak vVulkanCore, BaseNodeWeak vParentNode);

private:
	std::weak_ptr<VolumeRenderingModule> m_This;

	std::shared_ptr<VolumeRenderingModule_Comp_2D_Pass> m_VolumeRenderingModule_Comp_2D_Pass_Ptr = nullptr;

public:
	VolumeRenderingModule(GaiApi::VulkanCoreWeak vVulkanCore);
	~VolumeRenderingModule() override;
