...
class ScreenSpaceModule;
class ScreenSpaceNode : public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface, public BaseNode {
public:
    static std::shared_ptr<ScreenSpaceNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);

private:
    std::shared_ptr<ScreenSpaceModule> m_ScreenSpaceModulePtr = nullptr;

public:
    ScreenSpaceNode();
    ~ScreenSpaceNode() override;
