...
class LongLatPeviewNode : public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface, public BaseNode {
public:
    static std::shared_ptr<LongLatPeviewNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);

private:
    std::shared_ptr<LongLatPeviewModule> m_LongLatPeviewModulePtr = nullptr;

public:
    LongLatPeviewNode();
    ~LongLatPeviewNode() override;
