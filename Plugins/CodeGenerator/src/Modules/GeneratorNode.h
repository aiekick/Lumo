...
public:
    ...
    void GenerateModuleClasses(const std::string& vPath, const SlotDico& vDico);
    void GeneratePasseClasses(const std::string& vPath, const SlotDico& vDico);
...
private:  // Pass Shader Code
    std::string GetGlslHeader(const std::string& vStage, const bool& vIsAnEffect);
