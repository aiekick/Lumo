...
P3_C4::P3_C4() = default;
P3_C4::P3_C4(ct::fvec3 vp) {
    p = vp;
}
P3_C4::P3_C4(ct::fvec3 vp, ct::fvec4 vc) {
    p = vp;
    c = vc;
}
...
P3_N3_C4::P3_N3_C4(ct::fvec3 vp) {
    p = vp;
}
P3_N3_C4::P3_N3_C4(ct::fvec3 vp, ct::fvec3 vn) {
    p = vp;
    n = vn;
}
P3_N3_C4::P3_N3_C4(ct::fvec3 vp, ct::fvec3 vn, ct::fvec4 vc) {
    p = vp;
    n = vn;
    c = vc;
}
...
P3_N3_C4_D1::P3_N3_C4_D1(ct::fvec3 vp) {
    p = vp;
}
P3_N3_C4_D1::P3_N3_C4_D1(ct::fvec3 vp, ct::fvec3 vn) {
    p = vp;
    n = vn;
}
P3_N3_C4_D1::P3_N3_C4_D1(ct::fvec3 vp, ct::fvec3 vn, ct::fvec4 vc) {
    p = vp;
    n = vn;
    c = vc;
}
P3_N3_C4_D1::P3_N3_C4_D1(ct::fvec3 vp, ct::fvec3 vn, ct::fvec4 vc, float vd) {
    p = vp;
    n = vn;
    c = vc;
    d = vd;
...
P2_T2::P2_T2() = default;
P2_T2::P2_T2(ct::fvec2 vp) {
    p = vp;
}
P2_T2::P2_T2(ct::fvec2 vp, ct::fvec2 vt) {
    p = vp;
    t = vt;
}
...
P3_N3_T2::P3_N3_T2(ct::fvec3 vp) {
    p = vp;
}
P3_N3_T2::P3_N3_T2(ct::fvec3 vp, ct::fvec3 vn) {
    p = vp;
    n = vn;
}
P3_N3_T2::P3_N3_T2(ct::fvec3 vp, ct::fvec3 vn, ct::fvec2 vt) {
    p = vp;
    n = vn;
    t = vt;
}
...
P3_N3_T2_C4::P3_N3_T2_C4(ct::fvec3 vp) {
    p = vp;
}
P3_N3_T2_C4::P3_N3_T2_C4(ct::fvec3 vp, ct::fvec3 vn) {
    p = vp;
    n = vn;
}
P3_N3_T2_C4::P3_N3_T2_C4(ct::fvec3 vp, ct::fvec3 vn, ct::fvec2 vt) {
    p = vp;
    n = vn;
    t = vt;
}
P3_N3_T2_C4::P3_N3_T2_C4(ct::fvec3 vp, ct::fvec3 vn, ct::fvec2 vt, ct::fvec4 vc) {
    p = vp;
    n = vn;
    t = vt;
    c = vc;
...
P3_N3_TA3_BTA3_T2_C4::P3_N3_TA3_BTA3_T2_C4(ct::fvec3 vp) {
    p = vp;
}
P3_N3_TA3_BTA3_T2_C4::P3_N3_TA3_BTA3_T2_C4(ct::fvec3 vp, ct::fvec3 vn) {
    p = vp;
    n = vn;
}
P3_N3_TA3_BTA3_T2_C4::P3_N3_TA3_BTA3_T2_C4(ct::fvec3 vp, ct::fvec3 vn, ct::fvec3 vtan) {
    p = vp;
    n = vn;
    tan = vtan;
}
P3_N3_TA3_BTA3_T2_C4::P3_N3_TA3_BTA3_T2_C4(ct::fvec3 vp, ct::fvec3 vn, ct::fvec3 vtan, ct::fvec3 vbtan) {
    p = vp;
    n = vn;
    tan = vtan;
    btan = vbtan;
}
P3_N3_TA3_BTA3_T2_C4::P3_N3_TA3_BTA3_T2_C4(ct::fvec3 vp, ct::fvec3 vn, ct::fvec3 vtan, ct::fvec3 vbtan, ct::fvec2 vt) {
    p = vp;
    n = vn;
    tan = vtan;
    btan = vbtan;
...
P3_N3_TA3_BTA3_T2_C4::P3_N3_TA3_BTA3_T2_C4(ct::fvec3 vp, ct::fvec3 vn, ct::fvec3 vtan, ct::fvec3 vbtan, ct::fvec2 vt, ct::fvec4 vc) {
    p = vp;
    n = vn;
    tan = vtan;
    btan = vbtan;
