...
NodeSlotTextureGroupInput::NodeSlotTextureGroupInput() : NodeSlotInput("", "TEXTURE_2D_GROUP") {
    pinID = sGetNewSlotId();
    color = sGetSlotColors()->GetSlotColor(slotType);
    colorIsSet = true;
}

NodeSlotTextureGroupInput::NodeSlotTextureGroupInput(const std::string& vName) : NodeSlotInput(vName, "TEXTURE_2D_GROUP") {
    pinID = sGetNewSlotId();
    color = sGetSlotColors()->GetSlotColor(slotType);
    colorIsSet = true;
}
...
void NodeSlotTextureGroupInput::TreatNotification(const NotifyEvent& vEvent, const NodeSlotWeak& vEmitterSlot, const NodeSlotWeak& vReceiverSlot) {
