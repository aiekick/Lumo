...
NodeSlotTaskInput::NodeSlotTaskInput() : NodeSlotInput("", "TASK") {
    pinID = sGetNewSlotId();
    color = sGetSlotColors()->GetSlotColor(slotType);
    colorIsSet = true;
}

NodeSlotTaskInput::NodeSlotTaskInput(const std::string& vName) : NodeSlotInput(vName, "TASK") {
    pinID = sGetNewSlotId();
    color = sGetSlotColors()->GetSlotColor(slotType);
    colorIsSet = true;
}

NodeSlotTaskInput::NodeSlotTaskInput(const std::string& vName, const bool& vHideName) : NodeSlotInput(vName, "TASK", vHideName) {
    pinID = sGetNewSlotId();
    color = sGetSlotColors()->GetSlotColor(slotType);
    colorIsSet = true;
}
...
void NodeSlotTaskInput::TreatNotification(const NotifyEvent& vEvent, const NodeSlotWeak& vEmitterSlot, const NodeSlotWeak& /*vReceiverSlot*/) {
