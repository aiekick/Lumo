...
NodeSlotVariableInputPtr NodeSlotVariableInput::Create(
...
NodeSlotVariableInput::NodeSlotVariableInput() : NodeSlotInput("", "") {
    pinID = sGetNewSlotId();
...
void NodeSlotVariableInput::TreatNotification(const NotifyEvent& vEvent, const NodeSlotWeak& vEmitterSlot, const NodeSlotWeak& vReceiverSlot) {
                ...
                if (emiterSlotPtr->IsAnOutput()) {
                    ...
                    if (parentNodePtr) {
                        ...
                        if (parentVariableInputNodePtr) {
                            auto otherVariableNodePtr = dynamic_pointer_cast<VariableOutputInterface>(emiterSlotPtr->parentNode.lock());
                            if (otherVariableNodePtr) {
