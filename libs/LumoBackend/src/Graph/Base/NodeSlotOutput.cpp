...
NodeSlotOutput::NodeSlotOutput() : NodeSlot() {
    pinID = sGetNewSlotId();
    slotPlace = NodeSlot::PlaceEnum::OUTPUT;
}

NodeSlotOutput::NodeSlotOutput(const std::string& vName) : NodeSlot(vName) {
    pinID = sGetNewSlotId();
    slotPlace = NodeSlot::PlaceEnum::OUTPUT;
}

NodeSlotOutput::NodeSlotOutput(const std::string& vName, const std::string& vType) : NodeSlot(vName, vType) {
    pinID = sGetNewSlotId();
    slotPlace = NodeSlot::PlaceEnum::OUTPUT;
...
NodeSlotOutput::NodeSlotOutput(const std::string& vName, const std::string& vType, const bool& vHideName) : NodeSlot(vName, vType, vHideName) {
    pinID = sGetNewSlotId();
    slotPlace = NodeSlot::PlaceEnum::OUTPUT;
    color = sGetSlotColors()->GetSlotColor(slotType);
    colorIsSet = true;
