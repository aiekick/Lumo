...
NodeSlotInput::NodeSlotInput() : NodeSlot() {
    pinID = sGetNewSlotId();
    slotPlace = NodeSlot::PlaceEnum::INPUT;
}

NodeSlotInput::NodeSlotInput(const std::string& vName) : NodeSlot(vName) {
    pinID = sGetNewSlotId();
    slotPlace = NodeSlot::PlaceEnum::INPUT;
}

NodeSlotInput::NodeSlotInput(const std::string& vName, const std::string& vType) : NodeSlot(vName, vType) {
    pinID = sGetNewSlotId();
    slotPlace = NodeSlot::PlaceEnum::INPUT;
...
NodeSlotInput::NodeSlotInput(const std::string& vName, const std::string& vType, const bool& vHideName) : NodeSlot(vName, vType, vHideName) {
    pinID = sGetNewSlotId();
    slotPlace = NodeSlot::PlaceEnum::INPUT;
    color = sGetSlotColors()->GetSlotColor(slotType);
    colorIsSet = true;
