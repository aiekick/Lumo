...
bool CommonSystem::DrawImGui()
{
	...
	if (ImGui::CollapsingHeader("Camera"))
	{
		...
		if (m_CameraSettings.m_CameraMode == CAMERA_MODE_Enum::CAMERA_MODE_TURNTABLE_Y)
		{
			...
			ImGui::CheckBoxIcon("##lock_target_x", LUMO_BACKEND_CAMERA_ICON_LABEL_LOCK, &m_CameraSettings.m_TargetXYZLock.x); ImGui::SameLine(); if (ImGui::IsItemHovered()) ImGui::SetTooltip("lock camera target x\nfrom modification with mouse or gizmo");
			change |= ImGui::SliderFloatDefaultCompact(-1.0f, "Target X##tgtx", &m_CameraSettings.m_TargetXYZ.x, -10.0f, 10.0f, 0.0f);
			ImGui::CheckBoxIcon("##lock_target_y", LUMO_BACKEND_CAMERA_ICON_LABEL_LOCK, &m_CameraSettings.m_TargetXYZLock.y); ImGui::SameLine(); if (ImGui::IsItemHovered()) ImGui::SetTooltip("lock camera target y\nfrom modification with mouse or gizmo");
			change |= ImGui::SliderFloatDefaultCompact(-1.0f, "Target Y##tgty", &m_CameraSettings.m_TargetXYZ.y, -10.0f, 10.0f, 0.0f);
			ImGui::CheckBoxIcon("##lock_target_z", LUMO_BACKEND_CAMERA_ICON_LABEL_LOCK, &m_CameraSettings.m_TargetXYZLock.z); ImGui::SameLine(); if (ImGui::IsItemHovered()) ImGui::SetTooltip("lock camera target z\nfrom modification with mouse or gizmo");
			change |= ImGui::SliderFloatDefaultCompact(-1.0f, "Target Z##tgtz", &m_CameraSettings.m_TargetXYZ.z, -10.0f, 10.0f, 0.0f);

			ImGui::FramedGroupSeparator();

			ImGui::CheckBoxIcon("##lock_trans_x", LUMO_BACKEND_CAMERA_ICON_LABEL_LOCK, &m_CameraSettings.m_TransXYLock.x); ImGui::SameLine(); if (ImGui::IsItemHovered()) ImGui::SetTooltip("lock translation x");
			change |= ImGui::SliderFloatDefaultCompact(-1.0f, "Trans X##transx", &m_CameraSettings.m_TransXY.x, -10.0f, 10.0f, 0.0f);
			ImGui::CheckBoxIcon("##lock_trans_y", LUMO_BACKEND_CAMERA_ICON_LABEL_LOCK, &m_CameraSettings.m_TransXYLock.y); ImGui::SameLine(); if (ImGui::IsItemHovered()) ImGui::SetTooltip("lock translation y");
		...
		ImGui::CheckBoxIcon("##lock_rot_x", LUMO_BACKEND_CAMERA_ICON_LABEL_LOCK, &m_CameraSettings.m_RotationXYZLock.x); ImGui::SameLine(); if (ImGui::IsItemHovered()) ImGui::SetTooltip("lock rotation x\nfrom modification with mouse");
		change |= ImGui::SliderFloatDefaultCompact(-1.0f, "RotX##rotx", &m_CameraSettings.m_RotationXYZ.x, -3.14159f, 3.14159f, 0.0f);
		ImGui::CheckBoxIcon("##lock_rot_y", LUMO_BACKEND_CAMERA_ICON_LABEL_LOCK, &m_CameraSettings.m_RotationXYZLock.y); ImGui::SameLine(); if (ImGui::IsItemHovered()) ImGui::SetTooltip("lock rotation y\nfrom modification with mouse");
		change |= ImGui::SliderFloatDefaultCompact(-1.0f, "RotY##roty", &m_CameraSettings.m_RotationXYZ.y, -3.14159f, 3.14159f, 0.0f);
		ImGui::CheckBoxIcon("##lock_rot_z", LUMO_BACKEND_CAMERA_ICON_LABEL_LOCK, &m_CameraSettings.m_RotationXYZLock.z); ImGui::SameLine(); if (ImGui::IsItemHovered()) ImGui::SetTooltip("lock rotation z\nfrom modification with mouse");
		...
		//ImGui::FramedGroupSeparator();
		//ImGui::CheckBoxIcon("##lock_uni_scale", LUMO_BACKEND_CAMERA_ICON_LABEL_LOCK, &m_CameraSettings.m_UniformScaleLock); ImGui::SameLine(); if (ImGui::IsItemHovered()) ImGui::SetTooltip("lock scale");
		...
		if (m_CameraSettings.m_CameraMode == CAMERA_MODE_Enum::CAMERA_MODE_TURNTABLE_Y)
		{
			...
			ImGui::CheckBoxIcon("##lock_zoom", LUMO_BACKEND_CAMERA_ICON_LABEL_LOCK, &m_CameraSettings.m_ZoomLock); ImGui::SameLine(); if (ImGui::IsItemHovered()) ImGui::SetTooltip("lock zoom");
