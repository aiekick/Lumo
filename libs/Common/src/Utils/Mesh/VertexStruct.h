...
{
	class COMMON_API PipelineVertexInputState
	{
	public:
	...
	class COMMON_API P3_N3_TA3_BTA3_T2_C4
	{
	public:
		static void GetInputState(PipelineVertexInputState& vInputState);
