...
#include "NodeSlotTextureCubeOutput.h"
...
std::string NodeSlotTextureCubeOutput::getXml(const std::string& vOffset, const std::string& /*vUserDatas*/)
{
	std::string res;
...
bool NodeSlotTextureCubeOutput::setFromXml(tinyxml2::XMLElement* vElem, tinyxml2::XMLElement* vParent, const std::string& /*vUserDatas*/)
{
