...
class SSAOModule;
class SSAONode : public BaseNode, public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface {
public:
    static std::shared_ptr<SSAONode> Create(GaiApi::VulkanCoreWeak vVulkanCore);
