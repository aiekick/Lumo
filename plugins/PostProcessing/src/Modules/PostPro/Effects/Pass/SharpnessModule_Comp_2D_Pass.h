...
class SharpnessModule_Comp_2D_Pass : public EffectPass<1U>, public NodeInterface {
public:
    static std::shared_ptr<SharpnessModule_Comp_2D_Pass> Create(const ct::uvec2& vSize, GaiApi::VulkanCoreWeak vVulkanCore);
...
public:
    SharpnessModule_Comp_2D_Pass(GaiApi::VulkanCoreWeak vVulkanCore);
    ~SharpnessModule_Comp_2D_Pass() override;
