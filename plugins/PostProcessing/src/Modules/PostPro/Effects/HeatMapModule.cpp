...
bool HeatMapModule::DrawWidgets(const uint32_t& vCurrentFrame, ImGuiContext* vContextPtr, void* vUserDatas)
{
	ZoneScoped;
...
bool HeatMapModule::DrawOverlays(const uint32_t& vCurrentFrame, const ImRect& vRect, ImGuiContext* vContextPtr, void* vUserDatas)
{
	ZoneScoped;
...
bool HeatMapModule::DrawDialogsAndPopups(const uint32_t& vCurrentFrame, const ImRect& vMaxRect, ImGuiContext* vContextPtr, void* vUserDatas)
{
	ZoneScoped;
	...
	{
		if (m_HeatMapModule_Comp_2D_Pass_Ptr) {
			return m_HeatMapModule_Comp_2D_Pass_Ptr->DrawDialogsAndPopups(vCurrentFrame, vMaxRect, vContextPtr, vUserDatas);
		}
	}
...
void HeatMapModule::SetTexture(const uint32_t& vBindingPoint, vk::DescriptorImageInfo* vImageInfo, ct::fvec2* vTextureSize, void* vUserDatas) {	
	ZoneScoped;

	if (m_HeatMapModule_Comp_2D_Pass_Ptr) {
		m_HeatMapModule_Comp_2D_Pass_Ptr->SetTexture(vBindingPoint, vImageInfo, vTextureSize, vUserDatas);
	}
}
...
vk::DescriptorImageInfo* HeatMapModule::GetDescriptorImageInfo(const uint32_t& vBindingPoint, ct::fvec2* vOutSize, void* vUserDatas) {	
	ZoneScoped;

	if (m_HeatMapModule_Comp_2D_Pass_Ptr) {
		return m_HeatMapModule_Comp_2D_Pass_Ptr->GetDescriptorImageInfo(vBindingPoint, vOutSize, vUserDatas);
	}
