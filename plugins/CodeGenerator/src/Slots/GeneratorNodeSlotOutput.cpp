...
GeneratorNodeSlotOutput::GeneratorNodeSlotOutput() : NodeSlotOutput() {
    pinID = sGetNewSlotId();
    slotPlace = NodeSlot::PlaceEnum::OUTPUT;
}

GeneratorNodeSlotOutput::GeneratorNodeSlotOutput(const std::string& vName) : NodeSlotOutput(vName) {
    pinID = sGetNewSlotId();
    slotPlace = NodeSlot::PlaceEnum::OUTPUT;
}
