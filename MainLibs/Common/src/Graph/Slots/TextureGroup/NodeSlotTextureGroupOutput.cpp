...
#include "NodeSlotTextureGroupOutput.h"
...
std::string NodeSlotTextureGroupOutput::getXml(const std::string& vOffset, const std::string& /*vUserDatas*/)
{
	std::string res;
...
bool NodeSlotTextureGroupOutput::setFromXml(tinyxml2::XMLElement* vElem, tinyxml2::XMLElement* vParent, const std::string& /*vUserDatas*/)
{
