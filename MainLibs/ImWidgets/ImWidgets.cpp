...
bool ImGui::ColorEdit3DefaultForNode(float vWidth, const char* vName, float* vCol, float* vDefault)
{
	bool change = false;
	...
	ImGui::PushID(ImGui::IncPUSHID());
	ImGui::PushItemWidth(w);
	change |= ImGui::ColorEdit3(vName, vCol, ImGuiColorEditFlags_Float | ImGuiColorEditFlags_NoInputs);
	ImGui::PopItemWidth();
	ImGui::PopID();
...
bool ImGui::ColorEdit4DefaultForNode(float vWidth, const char* vName, float* vCol, float* vDefault)
{
	bool change = false;
	...
	ImGui::PushID(ImGui::IncPUSHID());
	ImGui::PushItemWidth(w);
	change |= ImGui::ColorEdit4(vName, vCol, ImGuiColorEditFlags_Float | ImGuiColorEditFlags_NoInputs);
	ImGui::PopItemWidth();
	ImGui::PopID();
