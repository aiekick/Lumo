...
class VariableModule : public conf::ConfigAbstract, public GuiInterface, public TaskInterface, public NodeInterface, public VariableOutputInterface {
public:
...
public:
    ...
    SceneVariableWeak GetVariable(const uint32_t& vVariableIndex, void* vUserDatas) override;
};