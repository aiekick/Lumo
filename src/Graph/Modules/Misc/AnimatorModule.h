...
{
public:
	static std::shared_ptr<AnimatorModule> Create(GaiApi::VulkanCorePtr vVulkanCorePtr, BaseNodeWeak vParentNode);

private:
	std::weak_ptr<AnimatorModule> m_This;
	GaiApi::VulkanCorePtr m_VulkanCorePtr = nullptr;

public:
	AnimatorModule(GaiApi::VulkanCorePtr vVulkanCorePtr);
	~AnimatorModule();
