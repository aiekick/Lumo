...
ModelRendererModule::ModelRendererModule(GaiApi::VulkanCoreWeak vVulkanCore) : TaskRenderer(vVulkanCore) {
    ZoneScoped;
...
bool ModelRendererModule::Init() {
    ...
    if (TaskRenderer::InitPixel(map_size)) {
        ...
        m_ModelRendererModule_Mesh_Pass_Ptr = std::make_shared<ModelRendererModule_Mesh_Pass>(m_VulkanCore);
        if (m_ModelRendererModule_Mesh_Pass_Ptr) {
            ...
            if (m_ModelRendererModule_Mesh_Pass_Ptr->InitPixel(
