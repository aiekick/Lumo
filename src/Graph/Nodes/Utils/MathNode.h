...
class MathModule;
class MathNode : public BaseNode, public Texture2DInputInterface<0U>, public Texture2DOutputInterface, public ShaderUpdateInterface {
public:
    static std::shared_ptr<MathNode> Create(GaiApi::VulkanCoreWeak vVulkanCore);
