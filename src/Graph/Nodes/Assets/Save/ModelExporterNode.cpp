...
#include <Graph/Modules/Assets/Save/ModelExporterModule.h>
...
bool ModelExporterNode::DrawDialogsAndPopups(
    ...
    if (m_ModelExporterModulePtr) {
        return m_ModelExporterModulePtr->DrawDialogsAndPopups(vCurrentFrame, vMaxRect, vContextPtr, vUserDatas);
    }
    return false;
}
