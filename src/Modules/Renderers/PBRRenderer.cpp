...
bool PBRRenderer::ExecuteAllTime(const uint32_t& vCurrentFrame, vk::CommandBuffer* vCmd)
{
	ZoneScoped;
...
void PBRRenderer::NeedResize(ct::ivec2* vNewSize, const uint32_t* vCountColorBuffers)
{
