...
#include "SmoothNormalModule_Pass.h"
...
SmoothNormalModule_Pass::SmoothNormalModule_Pass(vkApi::VulkanCorePtr vVulkanCorePtr) 
...
void SmoothNormalModule_Pass::ActionBeforeInit()
{
...
void SmoothNormalModule_Pass::ComputePass(vk::CommandBuffer* vCmd, const uint32_t& vPassNumber)
{
...
void SmoothNormalModule_Pass::SetModel(SceneModelWeak vSceneModel)
{
	ZoneScoped;
...
SceneModelWeak SmoothNormalModule_Pass::GetModel()
{
	ZoneScoped;
...
bool SmoothNormalModule_Pass::BuildModel()
{
...
void SmoothNormalModule_Pass::DestroyModel(const bool& vReleaseDatas)
{
	m_NormalDatas.clear();
	m_SBO_Normals_Compute_Helper.reset();
	m_SBO_Normals_Compute_Helper_BufferInfos = vk::DescriptorBufferInfo{ VK_NULL_HANDLE, 0, VK_WHOLE_SIZE };
...
bool SmoothNormalModule_Pass::UpdateLayoutBindingInRessourceDescriptor()
{
	ZoneScoped;
...
bool SmoothNormalModule_Pass::UpdateBufferInfoInRessourceDescriptor()
{
	ZoneScoped;
...
std::string SmoothNormalModule_Pass::GetComputeShaderCode(std::string& vOutShaderName)
{
	vOutShaderName = "SmoothNormalModule_Pass";
...
std::string SmoothNormalModule_Pass::getXml(const std::string& vOffset, const std::string& /*vUserDatas*/)
{
	std::string str;
...
bool SmoothNormalModule_Pass::setFromXml(tinyxml2::XMLElement* vElem, tinyxml2::XMLElement* vParent, const std::string& /*vUserDatas*/)
{
